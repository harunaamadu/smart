...
import { ArrowDownIcon, ArrowUpIcon, CheckIcon, ChevronsDownUpIcon } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronsDownUpIcon strokeWidth={2} className="pointer-events-none size-4 text-muted-foreground" />
